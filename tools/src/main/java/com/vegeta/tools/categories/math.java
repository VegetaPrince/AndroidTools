...
public class math {
	...
	public static double round(double toBeRounded, int digits) {
		if (digits < 0) {
			AndroidTools.log.e("must be greater than 0");
			return 0;
		}
		String formater = "";
	 ...
	 * Same as {@code getRandomInteger(0, max);}
	 *
	 * 
	 * @param max
	 *            value exclusive
	 ...
	 * Same as {@code getRandomDouble(0, max);}
	 *
	 * 
	 * @param max
	 *            value exclusive
	...
	/**
	 * Get a random position(object) from a list of generic objects.
	 * Using generics saves the trouble of casting the return object.
	 * 
	 * @param <T>
