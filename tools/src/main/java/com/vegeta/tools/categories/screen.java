...
public class screen {
    ...
    public static WindowManager getWindowManager() {
        return (WindowManager) AndroidTools.getContext().getSystemService(Context.WINDOW_SERVICE);
    }
    ...
    public static Integer getSmallestScreenWidthDp() {
        Configuration config = AndroidTools.getContext().getResources().getConfiguration();
    ...
    public static int convertDimenToPixel(int dimenResId) {
        return (int) AndroidTools.getContext().getResources().getDimension(dimenResId);
    }
    ...
    public static int deviceDPI() {
        return AndroidTools.getContext().getResources().getDisplayMetrics().densityDpi;
    }
    ...
    public static String deviceResolution() {
        DisplayMetrics metrics = AndroidTools.getContext().getResources().getDisplayMetrics();
