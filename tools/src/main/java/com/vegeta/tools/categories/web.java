...
public class web {
    ...
    public static boolean hasInternetConnection() {
        ConnectivityManager connectivity = (ConnectivityManager) AndroidTools.getContext()
    ...
    public static boolean changeWirelessState(boolean state) {
        try {
            WifiManager wifi = (WifiManager) AndroidTools.getContext().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean changeMobileDataState(boolean dataEnabled) {
        ...
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) AndroidTools.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean checkServerConnection(String serverURL) {
        ...
        try {
            ...
            AndroidTools.log.e("ExecutionException", e);
        }
        return value;
    }
